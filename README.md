## This repository is [Marlin Release 2.1.2](https://github.com/MarlinFirmware/Marlin/releases/tag/2.1.2) with additional configurations for [TRONXY](https://www.tronxy3d.com/) 3D Printers
